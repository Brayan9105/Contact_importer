...
ActiveRecord::Schema.define(version: 2021_05_12_171227) do
  ...
  create_table "books", force: :cascade do |t|
    ...
    t.integer "column_dob"
    t.integer "column_address"
    t.integer "column_credit_card"
    t.integer "column_franchise"
    t.integer "column_email"
    t.integer "column_phone"
